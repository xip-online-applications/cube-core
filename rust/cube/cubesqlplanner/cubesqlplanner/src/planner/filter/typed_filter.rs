            ...
            match operator {
                ...
                | FilterOperator::NotEndsWith => {
                    ...
                    let (negated, start_wild, end_wild) = match operator {
                        ...
                        FilterOperator::IStartsWith => (false, false, true),
                    ...
                    // `iStartsWith` is case-insensitive via `UPPER()` + `LIKE`
                    // rather than native `ILIKE` (see LikeOp), matching the
                    // JS-side `BaseFilter#iStartsWithWhere` semantics.
                    let case_insensitive_upper =
                        matches!(operator, FilterOperator::IStartsWith);
